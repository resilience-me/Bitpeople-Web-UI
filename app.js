...
async function handleFunctionSelect() {
    ...
    if (selectedFunction === 'approve') {
        ...
        inputFieldsDiv.innerHTML = `
            ...
            <input type="text" id="account" placeholder="Enter account address" class="address-input">
        `;
    } else if (selectedFunction === 'pseudonymEvent' || selectedFunction === 'toSeconds' || selectedFunction === 'registryLength' || selectedFunction === 'seed' || selectedFunction === 'shuffled' || selectedFunction === 'courts' || selectedFunction === 'permits' ) {
        inputFieldsDiv.innerHTML = `
